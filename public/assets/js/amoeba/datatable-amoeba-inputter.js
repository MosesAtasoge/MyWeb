			...
			columnDefs: [
				...
				},
				{
					...
					render: function(data, type, row) {
						...
						<a href="/amoeba/edit-amoeba/` + row[0] + `" class="btn btn-sm btn-clean btn-icon btn-icon-md center" title="Edit">
                          <i class="la la-edit"></i>
						</a>
						<form action="/amoeba/delete-amoeba/` + row[0] + `" method="POST" onsubmit="return confirm('Are you sure you want to delete?')">
